...
int main(int argc, char* argv)
{
  ...
  if (argc==1)
  {
    ...
    ret=dlevmar_der(expfunc, jacexpfunc, p, x, NULL, varTh, m, n, 1000, opts, info, work, covar, (void *)&data); // with analytic Jacobian
  ...
  else
  {
    ...
    ret=dlevmar_dif(expfunc, p, x, NULL, varTh, m, n, 1000, opts, info, work, covar, (void *)&data); // without Jacobian
