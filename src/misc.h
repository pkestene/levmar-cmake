...
extern float  slevmar_L2nrmxmy_var(float *e, float *x, float *y, float *var, int n, float varTh);
extern double dlevmar_L2nrmxmy_var(double *e, double *x, double *y, double *var, int n, double varTh);
